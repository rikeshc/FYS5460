...
[time, freq, val, phase, step, head] = import_signal_lts('case2.txt');
...
[time, freq, val, phase, step, head] = import_signal_lts('case3a.txt');
...
[time, freq, val, phase, step, head] = import_signal_lts('case3b.txt');
...
%time
[time, freq, val, phase, step, head] = import_signal_lts('case4a.txt');
...
%fft
[time, freq, val, phase, step, head] = import_signal_lts('case4b.txt');
...
%time
[time, freq, val, phase, step, head] = import_signal_lts('case5.txt');
