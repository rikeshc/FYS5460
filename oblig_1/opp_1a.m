...
legend('Vin', 'Vout @offset = 0', 'Vout @offset = -50mV',  'Vout @offset = -100mV',  'Vout @offset = -150mV',  'Vout @offset = -200mV,',  'Vout @offset = -250mV',  'Vout @offset = -300mV',  'Vout @offset = -350mV',  'Vout @offset = -400mV')
title('Negative offset at -ve terminal');
xlabel('Time(s)');
ylabel('Magnitude(V)');
xlim([0 3*10^-3]);
grid on;